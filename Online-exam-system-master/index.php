...
?>
<script>
function validateForm() {var y = document.forms["form"]["name"].value;  var letters = /^[A-Za-z]+$/;if (y == null || y == "") {alert("Name must be filled out.");return false;}var z =document.forms["form"]["USN"].value;if (z == null || z == "") {alert("USN must be filled out.");return false;}var x = document.forms["form"]["email"].value;var atpos = x.indexOf("@");
...
.clear{
  ...
  .rupee-symbol {
  color: #f4511e; /* Same color as .logo */
  font-size: 50px; /* Matches the .logo size */
  font-family: "Lato", "Arial", sans-serif; /* Ensures compatibility */
  font-weight: bold; /* Emphasizes the symbol */
  display: inline-block; /* Allows better alignment if needed */
}
...
<div class="jumbotron text-center">
  <h1>QUIZ CONDUCTION AND EVALUATION</h1> 
...
<div class="form-group">
  <label class="col-md-3 control-label" for="name"></label>  
  <div class="col-md-6">
  <input id="college" name="college" placeholder="Enter your USN" class="form-control input-md" type="text">
...
<div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    <div class="col-sm-4">
      ...
      <h4>GREEN</h4>
      <p>Eco friendly & Reduces paper work</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4>User Friendly</h4>
      <p>Anyone with limited knowledge can create/conduct quizzes</p>
    </div>
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        ...
        <p><strong>Maria Saji</strong></p>
        <p>MITT 3rd year CSE</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="profilepic.jpg" alt="VIJAY" width="400" height="300">
        <p><strong>Rahul Devaraj</strong></p>
        <p>MITT 3rd year CSE</p>
      </div>
    </div>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 7338226228 </p>
      <p><span class="glyphicon glyphicon-envelope"></span> head@gmail.com</p>
    </div>
...
<footer class="container-fluid text-center">
  ...
  <p>Thank you,hope u learned something new!</p>
</footer>
